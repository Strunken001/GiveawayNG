	...
	<div class="<?=(is_home() && $settings['home_header'] == '1' ? 'home_h hh':'header_h hh2');?>">
		...
		<div class="header_main">
			...
			<div class="open_account_menu usel_none">
				<div class="button3s b action_open_user_menu ov_visible">
					<div class="logged_name_elip">
						...
						if(isset($_SESSION['_logged_name'])){
							?>
			...
			<!--  completed contests -->
			<a href="index.php?completed_contests=1" class="inherit_dec_none">
				<div class="button b"><i class="fas fa-chart-line"></i>&nbsp;&nbsp; Past Contests & Winners </div>
			</a>
			...
			<div class="header_search">
				...
				<input type="text" id="searchinput" class="header_search_input" placeholder="<?=_LANG_SEARCH;?>"/>
			</div>
			<?php } ?>
