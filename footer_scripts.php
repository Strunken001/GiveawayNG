	...
	<?php
	if($_SESSION['_logged'] != 1){
		?>
	<script type="text/javascript" src="intl-tel-input-master/intl-tel-input-master/build/js/intlTelInput.js"></script>
	<?php
	}
		?>
	...
	<?php 
			if(isset($_SESSION['_logged_admin'])){
				...
				?>
			var logged_id = '<?=(isset($user_id) && is_numeric($user_id) ? $user_id : 0);?>';
				<?php
			}else{
				?>
