	...
	<div class="padding_20">
		...
		<div class="settings_results">
			...
			<form action="index.php?page=contest<?=(isset($cid) && is_numeric($cid) ? '&cid='.$cid : '');?>" method="post" id="contestForm">
			...
			<div class="setting">
				...
				<div class="setting_right">
					<input type="number" value="<?=(isset($site_contest['entry_fee']) ? $site_contest['entry_fee'] : '0');?>" name="entry_fee" />
				</div>
			</div>
			...
			<div class="setting">
				...
				<div class="setting_right">
					<button id="admin_create_contest" class="st_svb" type="submit" style="padding: 12px 18px;">Save changes</button>
					<!-- <input id="admin_create_contest" type="submit" name="submit" value="Save changes" class="st_svb"  /> -->
				</div>
			</div>
