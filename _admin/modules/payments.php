	...
	<div class="padding_20">
		...
		<div class="settings_results">
			...
			<div class="setting">
				...
				<div class="setting_right">
					<select name="payment_gateway" id="payment_gateway">
						...
						<option value="paystack" <?=(isset($site_settings['payment_gateway']) && $site_settings['payment_gateway'] == 'paystack' ? 'selected' :'');?>>Paystack</option>
					</select>
				</div>
			</div>
			...
			<div class="p_only_razorpay" <?=(isset($site_settings['payment_gateway']) && $site_settings['payment_gateway'] == 'razorpay' ? 'style="display:block;"':'style="display:none;"');?>>
			 ...
			 <!-- Paystack  -->
			<div class="p_only_paystack" <?=(isset($site_settings['payment_gateway']) && $site_settings['payment_gateway'] == 'paystack' ? 'style="display:block;"':'style="display:none;"');?>>

				<div class="setting">
					<div class="setting_left">Paystack Public Key</div>
					<div class="setting_right">
						<input type="text" placeholder="" value="<?=(isset($site_settings['payment_gateway']) && $site_settings['paystack_public_key'] != '' ? $site_settings['paystack_public_key'] : '');?>" name="paystack_public_key" />
					</div>
				</div>
			...
			<div class="setting">
				...
				<div class="setting_right">
					<select name="paypal_currency">
						...
						<option value="NGN" <?=(isset($site_settings['paypal_currency']) && $site_settings['paypal_currency'] == 'NGN' ? 'selected' : '');?>>Nigerian Naira (NGN)</option>
					</select>
				</div>
			</div>
